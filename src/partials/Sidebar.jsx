...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  const count = useSelector(state => state.theme.token)
  console.log("dddd", count.userEmail)
    ...
    <div>
      ...
      <div
        ...
        className={`  flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto 
         lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20
         lg:sidebar-expanded:!w-74 2xl:!w-64 shrink-0 bg-slate-800 p-2 transition-all duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-64"
          }`}
      >
        {/* Sidebar header */}
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase  font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block text-white fs-6">
            ...
            <ul className="mt-3">
                    ...
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          {count.userEmail == "user" || count.userEmail == "coordinator" || count.userEmail == "Client" ? "" : <>
                          ...
                          {count.userEmail == "coordinator"?<></>:<>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              end
                              to="/dashboard/riskCoordinator"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
              ...
              {/*  Case Management */}
              <SidebarLinkGroup
                activecondition={pathname.includes("caseManagement")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("caseManagement")
                            ? "hover:text-slate-200"
                            : "hover:text-white"
                          }`}
                        onClick={(e) => {
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current ${pathname.includes("caseManagement")
                                    ? "text-indigo-300"
                                    : "text-slate-400"
                                  }`}
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            {/* <NavLink
                              end to="/caseManagement/pendingCases"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
                                ...
                                {(handleClick, open) => {
                                  return (
                                    <React.Fragment>
                                      <a
                                        href="#0"
                                        className={` text-slate-200 truncate transition duration-150  ${pathname.includes("job")
                                            ? "hover:text-slate-200"
                                            : "hover:text-white"
                                          }`}
                                        onClick={(e) => {
                                      ...
                                      >
                                        <div className="flex  ">
                                          ...
                                          <div className="flex shrink-0 ml-1 ">
                                            <svg
                                              className={`w-3 h-3 shrink-0 ml-1 mr-5 mt-1 fill-current text-slate-400 ${open && "rotate-180"
                                                }`}
                                              viewBox="0 0 12 12"
                                            >
                                              <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                      ...
                                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                        <ul
                                          className={` mt-1 ${!open && "hidden"
                                            }`}
                                        >
                                          <li className="mb-1 last:mb-0">
                                            <NavLink
                                              end to="/caseManagement/pendingFromFieldExecutive"
                                              className={({ isActive }) =>
                                                "block transition duration-150 truncate " +
                                                (isActive
                                                  ? "text-indigo-500"
                                          ...
                                          <li className="mb-1 last:mb-0">
                                            <NavLink
                                              ...
                                              to="/caseManagement/pendingCaseQA"
                                              className={({ isActive }) =>
                                                "block transition duration-150 truncate " +
                                                (isActive
                                                  ? "text-indigo-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/caseManagement/decliendCases"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/caseManagement/highAgeingCase"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
              ...
              {/* Client Management */}
              {count.userEmail == "coordinator" || count.userEmail == "Client" ?"":<>
              <SidebarLinkGroup
                activecondition={pathname.includes(" clientManagement ")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {count.userEmail == "coordinator"?"":<>
              <SidebarLinkGroup
                activecondition={pathname.includes("report&Analytics")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {count.userEmail == "user" || count.userEmail == "coordinator" || count.userEmail == "Client" ? "" : <>
                <SidebarLinkGroup
                  activecondition={pathname.includes("role&Access")}
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
              ...
              {/* CMS */}
              {count.userEmail === "user" || count.userEmail == "coordinator" || count.userEmail == "Client" ? "" : <>
                <SidebarLinkGroup activecondition={pathname.includes("cms")}>
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <a
